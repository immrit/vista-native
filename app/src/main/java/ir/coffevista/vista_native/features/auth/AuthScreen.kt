        ...
        modifier = modifier
            ...
            .background(
                Brush.radialGradient(
                    listOf(
                        VistaColors.Cyan.copy(alpha = 0.18f),
        ...
        Column(
            ...
            if (state.step == AuthStep.IDENTIFIER) {
                ...
                Row(
                    ...
                    VistaBrandMark(Modifier.size(52.dp))
            ...
            Surface(
                ...
                Column(Modifier.padding(24.dp)) {
                    ...
                    AnimatedContent(
                        ...
                        Column {
                            when (step) {
                                AuthStep.IDENTIFIER -> IdentifierStep(state, onAction)
                                AuthStep.PASSWORD -> PasswordStep(state, onAction)
                                AuthStep.OTP -> OtpStep(state, onAction)
                                AuthStep.SET_PASSWORD -> PasswordSetupStep(state, onAction)
                            }
                        }
                    }
