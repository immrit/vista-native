...
private val slides = listOf(
    OnboardingSlide(
        ...
        imageRes = R.drawable.viu_connect,
        imageScale = 1.23f,
    ),
    OnboardingSlide(
        kicker = "برای هر لحظه",
        ...
        imageRes = R.drawable.viu_create,
        imageScale = 1.1f,
    ),
    OnboardingSlide(
        kicker = "با خیال راحت",
        ...
        imageRes = R.drawable.viu_private,
        imageScale = 1.16f,
    ),
)
...
fun OnboardingScreen(
    ...
    Column(
        ...
        Row(
            ...
            VistaBrandMark(Modifier.size(44.dp))
        ...
        ProgressRail(currentPage = state.page, accent = slide.accent)
